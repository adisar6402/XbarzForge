...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 flex flex-col overflow-x-hidden">
      ...
      <header className="relative z-10 flex h-20 items-center justify-between px-4 sm:px-6 md:px-12 border-b border-white/5 bg-background/50 backdrop-blur-xl">

        <div className="flex items-center gap-2 text-primary">
          <Terminal className="h-6 w-6" />
          <span className="font-mono font-bold text-lg sm:text-xl tracking-tight text-white">
            XbarzForge
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Button
            variant="ghost"
            className="text-gray-300 hover:text-white font-mono text-sm sm:text-base px-2 sm:px-4"
            asChild
          >
            <Link href="/sign-in">
              /login
          ...
          <Button
            className="bg-primary text-black hover:bg-primary/90 font-mono text-sm sm:text-base px-3 sm:px-6 shadow-[0_0_20px_-5px_rgba(11,217,235,0.5)]"
            asChild
          >
            <Link href="/sign-up">
              Initialize_
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center pt-24 pb-32">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 max-w-4xl text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500 animate-in fade-in slide-in-from-bottom-6 delay-150 fill-mode-both">
          ...
          The{" "}
          <span className="text-primary glow-effect bg-clip-text text-transparent bg-primary">
            IDE extension
          </span>{" "}
          you never had.
        ...
        <div className="flex flex-col sm:flex-row gap-6 animate-in fade-in slide-in-from-bottom-6 delay-500 fill-mode-both">
          ...
          <Link href="/demo">
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-14 px-8 text-lg border-white/10 hover:bg-white/5 font-mono"
            >
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full text-left px-4">
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
            ...
            <p className="text-gray-400">
              Instantly maps architectures, frameworks, and patterns across massive repositories without breaking a sweat.
            </p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
            ...
            <p className="text-gray-400">
              Ask highly specific questions about files, functions, and state management. Get back working, formatted code.
            </p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
            ...
            <p className="text-gray-400">
              Generate READMEs, API specs, and onboarding guides in seconds. Keep your docs as fresh as your main branch.
            </p>
          </div>
