            ...
            {isSignedIn ? (
              <>
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/dashboard">Continue_</Link>
                </Button>
              </>
            ) : (
              <>
  ...
  >
    /login
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/sign-up">Initialize_</Link>
                </Button>
              </>
            )}
          </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center pt-24 pb-32">
        ...
        <p className="text-xl text-gray-400 mb-12 max-w-2xl leading-relaxed animate-in fade-in slide-in-from-bottom-6 delay-300 fill-mode-both">
          A command center where developers get instant AI understanding of any
          codebase. Like pairing with a senior engineer who's read every file in
          the repo.
        </p>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full text-left px-4 animate-in fade-in slide-in-from-bottom-12 delay-700 fill-mode-both">
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 relative group overflow-hidden">
            ...
            <p className="text-gray-400">
              Instantly maps architectures, frameworks, and patterns across
              massive repositories without breaking a sweat.
            </p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 relative group overflow-hidden">
            ...
            <p className="text-gray-400">
              Ask highly specific questions about files, functions, and state
              management. Get back working, formatted code.
            </p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 relative group overflow-hidden">
            ...
            <p className="text-gray-400">
              Generate READMEs, API specs, and onboarding guides in seconds.
              Keep your docs as fresh as your main branch.
            </p>
          </div>
        </div>
      </main>
